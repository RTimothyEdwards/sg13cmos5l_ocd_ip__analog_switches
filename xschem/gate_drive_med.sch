...
N 760 -680 900 -680 { lab=S1_P}
N 900 -750 900 -680 { lab=S1_P}
N 900 -750 920 -750 { lab=S1_P}
N 780 -800 960 -800 { lab=vdd}
N 960 -800 960 -780 { lab=vdd}
N 900 -680 900 -590 { lab=S1_P}
N 900 -590 920 -590 { lab=S1_P}
...
N 1280 -750 1280 -680 { lab=S3_P}
N 1280 -750 1300 -750 { lab=S3_P}
N 1340 -800 1340 -780 { lab=vdd}
N 1280 -680 1280 -590 { lab=S3_P}
N 1280 -590 1300 -590 { lab=S3_P}
N 1340 -680 1340 -620 { lab=outn}
...
N 1460 -750 1460 -680 { lab=outn}
N 1460 -750 1480 -750 { lab=outn}
N 1520 -800 1520 -780 { lab=vdd}
N 1460 -680 1460 -590 { lab=outn}
N 1460 -590 1480 -590 { lab=outn}
N 1520 -680 1520 -620 { lab=out}
...
N 1140 -680 1280 -680 { lab=S3_P}
N 1340 -680 1460 -680 { lab=outn}
...
N 760 -660 760 -620 { lab=S1_P}
N 520 -660 520 -620 { lab=#net1}
N 760 -720 760 -680 { lab=S1_P}
N 960 -720 960 -680 { lab=S2_N}
N 1140 -720 1140 -680 { lab=S3_P}
N 1340 -720 1340 -680 { lab=outn}
N 1520 -720 1520 -680 { lab=out}
N 610 -750 700 -660 {lab=S1_P}
N 560 -750 610 -750 {lab=S1_P}
N 700 -660 760 -660 {lab=S1_P}
N 760 -680 760 -660 { lab=S1_P}
...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 1320 -750 0 0 {name=M9
l=0.5u
w=10u
ng=1
m=16
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 1320 -590 0 0 {name=M10
l=0.5u
w=5u
ng=1
m=16
...
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 1500 -750 0 0 {name=M11
l=0.5u
w=10u
ng=1
m=16
...
C {sg13cmos5l_pr/sg13_hv_nmos.sym} 1500 -590 0 0 {name=M12
l=0.5u
w=5u
ng=1
m=16
...
C {devices/lab_wire.sym} 1400 -680 0 1 {name=l9 sig_type=std_logic lab=outn}
C {devices/lab_wire.sym} 860 -680 0 0 {name=l18 sig_type=std_logic lab=S1_P
}
C {devices/lab_wire.sym} 1040 -680 0 0 {name=l19 sig_type=std_logic lab=S2_N}
C {devices/lab_wire.sym} 1560 -680 0 0 {name=l21 sig_type=std_logic lab=out}
C {devices/opin.sym} 250 -800 0 0 {name=p4 lab=out}
C {devices/lab_wire.sym} 1230 -680 0 0 {name=l5 sig_type=std_logic lab=S3_P}
C {devices/opin.sym} 250 -770 0 0 {name=p2 lab=outn}
