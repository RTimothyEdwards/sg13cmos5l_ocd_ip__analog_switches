/* Behavioral verilog model for the 1.2V power switch */
...
module power_stage1v2 (
    ...
    /* Analog signals */
    input wire real DVDD_IN,
    output wire real DVDD_OUT
);
...
assign pint = (DVDD_IN < PMOS_FLOOR) ? PMOS_FLOOR : DVDD_IN;
 ...
 */
assign DVDD_OUT = (enable === 1'b1) ? pint : NAN;
