/* Behavioral verilog model for the 3.3V power switch (waffle pMOS, INVERTED enable) */
...
/* Conducts when nenable is 0 --- THIS PART IS ACTIVE LOW */
 ...
 */
assign IOVDD_OUT = (nenable === 1'b0) ? pint : NAN;
